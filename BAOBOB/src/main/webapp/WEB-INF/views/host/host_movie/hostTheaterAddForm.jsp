				...
				<div class="col-lg-2">
					<div class="card mb-3">
						<button type="button" class="btn btn-primary"
							onclick="hostTheaterAdd();">등록</button>
					</div>
					<div class="card mb-3">
						<div class="card-header">상영관 설정</div>
						<div class="card-body" align="center">
							<input class="form-control" type="number" id="theater_index"
								name="theater_index" placeholder="빈 영화관의 index(관)" required /> 
							<input class="form-control" type="text" id="row" name="theater_row"
								placeholder="행 갯수(최대 26)" required /> 
							<input class="form-control" type="text" id="col" name="theater_col"
								placeholder="열 갯수" required />
							<br>
							<input type="hidden" id="chkConfirm" value==0 />
							<button class="btn btn-primary" type="button" onclick="seatSet();">
								확인
							</button>
