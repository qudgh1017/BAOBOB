		...
		<div class="container-fluid row">
			...
			<div class="col-lg-2">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						기본 시간(분)  <input class="form-control" name="baseTime" id="baseTime" type="number" min="0" max="1440" value="${pf.p_fee_base_time}" required><br>
						기본 요금  <input class="form-control" name="baseFee" id="baseFee" type="number" min="0" max="10000" value="${pf.p_fee_base_price}" required><br>
						초과 시간 (분) <input class="form-control" name="excTime" id="excTime" type="number" min="0" max="1440" value="${pf.p_fee_exc_time}" required><br>
						초과 요금  <input class="form-control" name="excFee" id="excFee" type="number" min="0" max="10000" value="${pf.p_fee_exc_price}" required><br>
					</div>
				</div>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						가로  <input class="form-control" id="widthX" type="number" min="1" max="100" value="${pSpace.p_space_col}" onchange="spaceDivChange();" required><br>
						세로  <input class="form-control" id="heightY" type="number" min="1" max="100" value="${pSpace.p_space_row}" onchange="spaceDivChange();" required>
