...
<html>
  <head>
    ...
    <link href="${projectRes}mainBootstrap/vendor/font-awesome/fonts/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic" rel="stylesheet" type="text/css">

    <!-- Plugin CSS -->
    <link href="${projectRes}mainBootstrap/vendor/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css">

    <!-- Custom styles for this template -->
    <link href="${projectRes}mainBootstrap/css/freelancer.min.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="${projectRes}mainBootstrap/img/profile.png" alt="">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-4">
              ...
              <img class="img-fluid" src="${projectRes}mainBootstrap/img/portfolio/game.png" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-5">
              ...
              <img class="img-fluid" src="${projectRes}mainBootstrap/img/portfolio/safe.png" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-6">
              ...
              <img class="img-fluid" src="${projectRes}mainBootstrap/img/portfolio/submarine.png" alt="">
            </a>
          </div>
        </div>
      </div>
