		...
		<th>
			...
			<table id="mainBody" style="width:800px; margin:auto;">
				<tbody>
					<tr>
						<th colspan="3">
							<input type="text" name="subject" maxlength="50" style="width:650px;" placeholder="어떤 영화를 보셨나요?">
						</th>	
					</tr>
			...
			<table id="mainBody" style="width:800px; margin:auto;">
				...
				<c:if test="${cnt > 0 }">
					<c:forEach var="dto" items="${dtos}">
					    ...
					    <tr>
					    	<td colspan="2" style="text-align:left; border-bottom: 3px solid black;">
					    		${dto.board_content}
					    	</td>
					    	<td style="text-align:center; border-bottom: 3px solid black;">
					    		<input type="button" onclick="window.location='movieDiaryDel?num=${dto.board_index}'" value="삭제">
					    	</td>
					    </tr>
					    </tbody>
					    <%-- </c:if> --%>
