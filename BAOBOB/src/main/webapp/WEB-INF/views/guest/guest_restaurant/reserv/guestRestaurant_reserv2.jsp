...
<body class="bg-dark">
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			<div class="card-header">식당이름</div>
			<div class="card-body">
				<form action="mainSignInPro" name="mainSignInForm" method="post" onsubmit="return signInChk();">
					...
					<div class="table_reserv">
					테이블 예약 공간
					</div>
					<button class="btn btn-primary btn-block" type="button" onclick="firebaseLogin();">예약 접수</button>
					<button class="btn btn-primary btn-block" type="button" onclick="firebaseLogin();">취소</button>
				</form>
			</div>
		</div>
	</div>
